...
public class BlockRibbon extends Block implements IWaterLoggable {

    protected static final VoxelShape EAST_AABB = Block.makeCuboidShape(0.0D, 0.5D, 1.5D, 1.0D, 16.0D, 15.0D);
    protected static final VoxelShape WEST_AABB = Block.makeCuboidShape(15.0D, 0.5D, 1.5D, 16.0D, 16.0D, 15.0D);
    protected static final VoxelShape SOUTH_AABB = Block.makeCuboidShape(1.5D, 0.5D, 0.0D, 15.0D, 16.0D, 1.0D);
    protected static final VoxelShape NORTH_AABB = Block.makeCuboidShape(1.5D, 0.5D, 15.0D, 15.0D, 16.0D, 16.0D);
