...
public class ItemSpawnEgg extends SpawnEggItem {
    ...
    public ItemSpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColour, final int secondaryColour, final Properties properties) {
