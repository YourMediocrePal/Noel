...
public class BlockOrnament extends WallMountedBlock {
    ...
    static {
        DOWN_SHAPE = Block.createCuboidShape(5.0D, 0.0D, 5.0D, 11.0D, 6.0D, 11.0D);
        UP_SHAPE = Block.createCuboidShape(5.0D, 9.0D, 5.0D, 11.0D, 15.0D, 11.0D);
        NORTH_SHAPE = Block.createCuboidShape(5.0D, 5.0D, 10.0D, 11.0D, 11.0D, 16.0D);
        SOUTH_SHAPE = Block.createCuboidShape(5.0D, 5.0D, 0.0D, 11.0D, 11.0D, 6.0D);
        EAST_SHAPE = Block.createCuboidShape(0.0D, 5.0D, 5.0D, 6.0D, 11.0D, 11.0D);
        WEST_SHAPE = Block.createCuboidShape(10.0D, 5.0D, 5.0D, 16.0D, 11.0D, 11.0D);
    }
