...
public class ItemSpawnEgg extends SpawnEggItem {
    ...
    public ItemSpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColour, final int secondaryColour, final Item.Properties properties) {
    ...
    public static void initSpawnEggs() {
        ...
        for (final ItemSpawnEgg spawnEgg : UNADDED_EGGS) {
